...
- **Framework**: React Native 0.73.6 with Expo ~50.0.0 and TypeScript ~5.3.0
- **Navigation**: Expo Router ~3.4.0 (file-based routing with typed routes)
- **Authentication**: Clerk Expo ^1.0.0 with expo-secure-store ~12.8.1 for token management
- **State Management**: React Query (@tanstack/react-query) ^5.0.0
- **UI Components**: React Native core components with expo/vector-icons
- **Video Streaming**: expo-av ~13.10.6 for video playback (implemented)
- **Additional UI**: expo-linear-gradient ~12.7.2 for enhanced styling
- **Testing**: Jest ^29.2.1 with jest-expo ~50.0.0 preset
- **Code Quality**: ESLint ^8.0.0 with TypeScript ESLint ^6.0.0
- **Platform Support**: iOS and Android with React Native 0.73.6
